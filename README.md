...
| JSON  |  JSON can be strings, numbers, booleans, null. arrays, and objects(most used). Typically an object with key-value pairs. JSON is valid javascript  |   ***Is it stored in arrays?*** \n ***why does is usually come as a string?*** |   Example is what one gets back from Pokemon api with Postman.  |  |
