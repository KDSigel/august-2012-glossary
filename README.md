...
| JSON  |  JSON can be strings, numbers, booleans, null. arrays, and objects(most used). Typically an object with key-value pairs.   |  Example is what one gets back from Pokemon api with Postman   |     |  |
| parsing JSON  |     |     |     |  |
| XML  |     |     |     |  |
| postgress  |     |     |     |  |
| jest  |     |     |     |  |
